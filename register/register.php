...
<body>
  ...
  <div class="register">
    ...
    <form class="registerForm" method="post">
      ...
      <input type="text" name="first_name" id="first_name" class="registerInput" placeholder="Enter your first name..."
        value="" />
      <label>Last Name</label>
      <input type="text" name="last_name" id="last_name" class="registerInput" placeholder="Enter your last name..."
        value="" />
      <label>Email</label>
      <input type="text" name="email_address" id="email_address" class="registerInput" placeholder="Enter your email..."
        value="" />
      <label>Password</label>
      <input type="password" name="password" id="password" class="registerInput" placeholder="Enter your password..."
        value="" />
      <label>Confirm password</label>
      <input type="password" name="confirm_password" id="confirm_password" class="registerInput"
