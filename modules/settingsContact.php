...
<body>
    <div class="secretary">
        ...
        <div class="secretaryPanel">
            ...
            <!-- SETTINGS AMENITY -->
            <label class="lblSettings" id="amenity">Contact Information</label>
                    ...
                    <form method="post" autocomplete="off">
                        ...
                        <table class="tblAmenityForm">
                            ...
                            <tr>
                                <td>Email:</td>
                                <td>
                                    <input name="newEmail" value="<?php echo $email ?? ''; ?>" type="text" placeholder="new email" required />
                                </td>
                            </tr>
                            <tr>
                                <td>Telephone:</td>
                                <td>
                                    <input name="newTelephone" value="<?php echo $telephone ?? ''; ?>" type="text" placeholder="new telephone" required />
                                </td>
                            </tr>
                        </table>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Do you really want to add this new contact?
                                    </div>
                                    <div class="modal-footer">
                                        <button name="contactAdd" type="submit" class="btn btn-primary">Save Changes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal fade" id="updateAmenityModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Do you really want to update this contact?
                                        </div>
                                        <div class="modal-footer">
                                            <button name="contactUpdate" type="submit" class="btn btn-primary">Save Changes</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="reset" class="btn btn-danger" data-bs-dismiss="modal" onclick="location.href='settingsContact.php'">Clear</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tblAmenityContainer">
                    <table class="table tblAmenity">
                        ...
                        <?php while ($row = $resultContact->fetch_assoc()) : ?>
                            <tr>
                                <td>
                                    <a href="settingsContact.php?contact_id=<?php echo $row['contact_id']; ?>" class="btnEdit">Edit</a>
                                </td>
